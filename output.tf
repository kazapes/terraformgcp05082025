...
output "instance_external_ips" {
  value = {
    vm1 = "http://${google_compute_instance.hqinternal-sc-vm.network_interface[0].access_config[0].nat_ip}"
    vm2 = "http://${google_compute_instance.secinternal-sc-vm.network_interface[0].access_config[0].nat_ip}"
  }
