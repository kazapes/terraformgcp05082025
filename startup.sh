...
<head>
  ...
  <style>
    ...
    .bgimg {
      background-image: url('https://images.pond5.com/panoramic-shot-table-mountain-cape-photo-228876218_iconl.jpeg');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://www.shutterstock.com/shutterstock/videos/3562964753/preview/stock-footage-capetown-south-africa-drone-flight-at-camps-bay.webm"
              width="500"
              height="270"
